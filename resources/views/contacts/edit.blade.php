                    ...
                    <div class="container px-5 mx-auto">
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    <label for="name" class="leading-7 text-sm text-gray-600">指名</label>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="radio" id="gender" name="gender" value="0" @if($contact->gender === 0 ) checked @endif>男性
                                    <input type="radio" id="gender" name="gender" value="1" @if($contact->gender === 1 ) checked @endif>女性
                                </div>
                                </div>
